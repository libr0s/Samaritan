...
public class UserActionsActivity extends AppCompatActivity{
        ...
        for(i = 0; i < actions.size(); i++){
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(UserActionsActivity.this, ActionActivity.class);
    ...
    public ArrayList<Action> loadUsersActions(){
        ...
        a.add(new Action("Wolontariat", "12-12-2018", "Bardzo fajna sprawa", true));
        a.add(new Action("Pomoc starszym", "12-12-2018", "Przeprowadzanie przez ulice", true));
        a.add(new Action("Czytanie dzieciom", "12-12-2018", "Bajki o smutnych programistach", true));
        a.add(new Action("Zbiorka pieniedzy", "12-12-2018", "Zbiorka na pomoc chorym", true));
