...
.rrui__activity-indicator__arc {
  ...
  border-radius: 50%;
  -webkit-animation: rrui__activity-indicator 1.2s cubic-bezier(0.5, 0.15, 0.5, 0.85) infinite;
...
@-webkit-keyframes rrui__activity-indicator {
  0% {
...
.rrui__autocomplete .rrui__options-list {
  /*
	...
	*/
  width: calc(100% + (0.6rem * 1.5 - 0rem) * 2);
...
.rrui__checkbox__focus-ring {
  display: block;
  position: absolute;
  left: calc(-1 * (250% - 100%) / 2);
  top: calc(-1 * (250% - 100%) / 2);
  width: 250%;
  height: 250%;
  border-radius: 50%;
  z-index: 0; }
...
.DayPicker-NavButton {
  position: absolute;
  top: calc(0.6rem * 2 + 0.25em);
  cursor: pointer;
  width: 1.5em;
  height: 1.5em; }

.DayPicker-NavButton--prev {
  left: calc(0.6rem * 2 + 0.25em);
...
.rrui__options-list--left-aligned {
  left: calc((0.6rem * 1.5 - 0rem) * -1); }

.rrui__options-list--right-aligned {
  right: calc((0.6rem * 1.5 - 0rem) * -1); }
...
.rrui__expansion-panel__header {
  ...
  -webkit-transition: height 210ms cubic-bezier(0.4, 0, 0.2, 1);
  -o-transition: height 210ms cubic-bezier(0.4, 0, 0.2, 1);
...
.rrui__expansion-panel--toggle-icon-end .rrui__expansion-panel__header {
  background-color: #F3F3F3; }

.rrui__expansion-panel--toggle-icon-end .rrui__expansion-panel__header:focus {
  -webkit-box-shadow: inset 0 0 0 1px #cacaca;
          box-shadow: inset 0 0 0 1px #cacaca; }

.rrui__expansion-panel--toggle-icon-start .rrui__expansion-panel__header:focus .rrui__expansion-panel__heading {
  padding-bottom: 0.15em;
  border-bottom: 1px solid #03b2cb; }

.rrui__expansion-panel--toggle-icon-start .rrui__expansion-panel__header:active .rrui__expansion-panel__heading {
  border-bottom: 1px solid #2bd7f0; }

.rrui__expansion-panel--toggle-icon-start.rrui__expansion-panel--expanded .rrui__expansion-panel__header {
  height: calc(0.6rem * 4); }
...
.rrui__expansion-panel__icon {
  ...
  top: 50%;
  width: 0.6rem;
  -webkit-transition: -webkit-transform 210ms cubic-bezier(0.4, 0, 0.2, 1);
  transition: -webkit-transform 210ms cubic-bezier(0.4, 0, 0.2, 1);
  -o-transition: transform 210ms cubic-bezier(0.4, 0, 0.2, 1);
  transition: transform 210ms cubic-bezier(0.4, 0, 0.2, 1);
  transition: transform 210ms cubic-bezier(0.4, 0, 0.2, 1), -webkit-transform 210ms cubic-bezier(0.4, 0, 0.2, 1); }
...
.rrui__expansion-panel--expanded .rrui__expansion-panel__icon--end {
...
.rrui__expansion-panel--expanded .rrui__expansion-panel__icon--start {
  -webkit-transform: translateY(-50%) rotate(0deg);
      -ms-transform: translateY(-50%) rotate(0deg);
          transform: translateY(-50%) rotate(0deg); }
...
.rrui__select__native:focus + .rrui__select__button--invalid {
  border-color: #d30f00; }
...
.rrui__menu-button {
  position: relative;
  display: inline-block;
  width: calc(0.6rem * 3 + 0.6rem);
  height: calc(0.6rem * 3 + 0.6rem);
  padding: calc(0.6rem / 2);
...
.rrui__slideout-menu {
  ...
  -webkit-transition: -webkit-transform 220ms ease-out, -webkit-box-shadow 220ms ease-out;
  transition: -webkit-transform 220ms ease-out, -webkit-box-shadow 220ms ease-out;
  -o-transition: transform 220ms ease-out, box-shadow 220ms ease-out;
  transition: transform 220ms ease-out, box-shadow 220ms ease-out;
  transition: transform 220ms ease-out, box-shadow 220ms ease-out, -webkit-transform 220ms ease-out, -webkit-box-shadow 220ms ease-out; }
...
.rrui__slideout-menu__item {
  ...
  padding-left: calc(0.6rem * 2.5 * 1.5);
  padding-right: calc(0.6rem * 2.5 * 1.5);
  color: currentColor;
  opacity: 0;
  -webkit-transition: opacity calc(220ms / 2) ease-out;
  -o-transition: opacity calc(220ms / 2) ease-out;
  transition: opacity calc(220ms / 2) ease-out; }
...
.rrui__switch__input:focus + .rrui__switch__groove {
  -webkit-box-shadow: inset 0 0 0 0.0625em rgba(0, 0, 0, 0.16), 0 0 0 0 transparent;
...
.rrui__switch__input:focus + .rrui__switch__groove--on {
  -webkit-box-shadow: inset 0 0 0 0.73em currentColor, 0 0 0 0 transparent;
...
.rrui__switch__knob {
  ...
  left: 0.0625em;
  background-color: #ffffff;
  -webkit-box-shadow: inset 0 0 0 0.03em rgba(0, 0, 0, 0.3), inset 0 0 0 0.03em transparent, 0 0 0.05em rgba(0, 0, 0, 0.05), 0 0.1em 0.2em rgba(0, 0, 0, 0.2);
...
.rrui__switch__input:focus + .rrui__switch__groove + .rrui__switch__knob {
  -webkit-box-shadow: inset 0 0 0 0.03em rgba(0, 0, 0, 0.3), inset 0 0 0 0.03em #03b2cb, 0 0 0.05em rgba(0, 0, 0, 0.05), 0 0.1em 0.2em rgba(0, 0, 0, 0.2);
...
.rrui__input-field:not(:focus) + .rrui__text-input__label--placeholder {
  -webkit-transform: translateX(0rem) translateY(0) scale(1);
      -ms-transform: translateX(0rem) translateY(0) scale(1);
...
.rrui__tooltip {
  opacity: 0;
  -webkit-transform: translateY(0.2em) scale(0.97);
      -ms-transform: translateY(0.2em) scale(0.97);
