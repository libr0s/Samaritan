	...
	_createClass(ExpandableMenu, [{
		...
		value: function render() {
			var _props = this.props,
			    ...
			    rest = _objectWithoutProperties(_props, ['upward', 'alignment', 'scrollIntoView', 'closeButtonIcon', 'closeLabel', 'style', 'className', 'toggler', 'togglerAriaLabel', 'togglerAriaHasPopup', 'togglerClassName', 'children']);
