...
action_update_parser = reqparse.RequestParser(bundle_errors=True)
action_update_parser.add_argument('name', type=str, store_missing=False)
action_update_parser.add_argument('points', type=int, store_missing=False)
action_update_parser.add_argument('start_date', type=date_parser, store_missing=False)
action_update_parser.add_argument('end_date', type=date_parser, store_missing=False)
action_update_parser.add_argument('geo', type=geo_loc_parser, store_missing=False)
